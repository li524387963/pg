...
var pickerEvent = {
    Init: function (e) {
        ...
        document.getElementById("calendar_choose").style.top = 100+'px';
        document.getElementById("calendar_choose").style.zIndex = 1000+'px';
        //getMonthData
        //date_text
        document.getElementById("date_text").onclick= function () {
            commonUtil.getMonthData(this)
        }
...
var pickerHtml = {
    ...
    getLeft: function () {
        var left = '<div class="calendar_left pkg_double_month"><div class="date_text" id="date_text"  style="cursor:pointer">' + obj.year + '年<br>' + obj.month + '月</div><a href="javascript:void(0)" title="上一月" id="picker_last" class="pkg_circle_top">上一月</a><a href="javascript:void(0)" title="下一月" id="picker_next" class="pkg_circle_bottom ">下一月</a></div>';
        htmlObj.left = left;
    },
    getRight: function () {
        ...
        for (var i = 1; i <= 42; i++) {
            ...
            if ((i - 1) >= week && (i - c) <= days) {
                ...
                if (price != -9999 && obj.year == new Date().getFullYear() && obj.month == new Date().getMonth() + 1 && i - c == new Date().getDate()) {
...
var dateUtil = {
    ...
    getLastDate: function () {
        ...
        // var date = formatDate(obj.year,obj.month,01);
...
var commonUtil = {
    ...
    getMonthData:function (sender) {
       // var date = sender.getAttribute("date");
        var date = formatDate(obj.year,obj.month);
        postMonthData(date);
    ...
    chooseClick: function (sender) {
        ...
        //     }
        //     changePrice(date);//设置修改价格，该方法需要自己实现
        //
        // })
